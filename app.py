...
def home():
    ...
    "Bro, kahit isang araw lang muna — wag mong isipin ang bukas. Clean today is enough.",
    "Salamat Lord sa bagong chance. Walang sugal ngayon, promise.",
    "One moment at a time. Hindi kailangan maging super strong agad. Step by step lang.",
    "Hindi ako perfect, pero hindi rin ako sumusuko. Kaya ko pa 'to.",
    "Diyos, alisin Mo yung urge ngayong araw. Bigyan Mo ako ng kapalit na kapayapaan.",
    "Lowkey lang ang laban. Walang need magmalaki. Basta clean, panalo na.",
    "Minsan mahina ako, pero may Diyos na laging kasama. One day at a time.",
    "Salamat sa pamilya ko kahit hindi nila alam lahat. Gagawin ko 'to para sa kanila.",
    "Wag mahiya humingi ng tulong. Hindi kahinaan 'yon — lakas 'yon.",
    "Bawat oras na hindi ako naglaro, mas malakas ako kaysa kahapon.",
    "Lord, tulungan Mo ako maging matatag ngayong araw. Isa-isang hakbang lang.",
    "Hindi ko kailangan maging number 1 sa clean streak. Enough na yung ngayon.",
    "Kahit relapse dati, tumayo pa rin ako. Kaya ko ulit 'yan.",
    "Bro, wag mong isipin ang mga panalo mo noon. Isipin mo ang panalo mo ngayon — clean.",
    "Salamat sa maliit na tagumpay. Walang sugal kahapon, walang sugal ngayon.",
    "Diyos, bigyan Mo ako ng lakas na harapin ang urge nang hindi ako natatalo.",
    "One day at a time. Hindi kailangan magmadali. Basta patuloy lang.",
    "Hindi ako nag-iisa sa laban na 'to. Marami tayong ganito.",
    "Lord, tulungan Mo ako na maging mas malakas sa pamilya ko kaysa sa sugal.",
    "Kahit mahirap, mas mahirap kapag natalo ka ulit. Kaya choose clean today.",
    "Wag mag-alala kung mabagal ang progress. Basta hindi ka tumitigil.",
    "Bro, proud ako sa'yo kahit isa lang ang araw mo. Keep going.",
    "Salamat sa bagong umaga na wala pang sugal. Gagawin ko ulit 'to bukas.",
    "Diyos, alisin Mo yung isip ko sa app at ilagay sa pamilya ko.",
    "Lowkey wins. Hindi kailangan ipost. Basta alam ko, panalo na.",
    "Isa-isang oras lang. Hindi kailangan isipin ang buong linggo.",
    "Hindi ako mahina. Nahulog lang ako, pero tumatayo pa rin.",
    "Salamat sa mga taong naniniwala sa akin kahit hindi ko pa nasasabi lahat.",
    "Lord, bigyan Mo ako ng kapalit na saya na hindi galing sa sugal.",
    "Kahit maliit lang ang hakbang ko ngayon, importante na tumutungo ako.",
    "Bro, wag mong kalimutan kung gaano kahirap yung dati. Kaya mo na 'to.",
    "One day clean ulit. Reset lang, hindi end of the world.",
    "Diyos, tulungan Mo ako na maging tapat sa sarili ko ngayong araw.",
    "Hindi kailangan maging perfect. Kailangan lang maging consistent.",
    "Salamat sa pagkakataong magsimula ulit kahit ilang beses nang nadulas.",
    "Lowkey lang ang laban. Walang pressure, basta tuloy lang.",
    "Lord, bigyan Mo ako ng lakas na harapin ang mga trigger ngayon.",
    "Isa-isang araw na walang sugal. Yun lang muna, yun lang.",
    "Bro, proud ako sa sarili ko kahit isa lang ang araw ko ngayon.",
    "Wag mahiya humingi ng tulong. Hindi kahinaan 'yon — lakas 'yon.",
    "Salamat sa pamilya ko kahit hindi pa nila alam lahat. Para sa kanila 'to.",
    "Kahit mahina ang loob ko minsan, may Diyos na laging kasama.",
    "One moment at a time. Hindi kailangan magmadali. Basta patuloy.",
    "Diyos, alisin Mo yung isip ko sa pera at ilagay sa totoong halaga ng buhay.",
    "Hindi ako nag-iisa. Marami tayong lumalaban sa parehong laban.",
    "Lord, tulungan Mo ako na maging mas mabuting tatay/asawa/anak ngayong araw.",
    "Wag isipin ang mga panalo mo noon. Isipin mo ang panalo mo ngayon — clean.",
    "Isa-isang hakbang lang. Hindi kailangan maging malaking hakbang agad.",
    "Bro, kaya mo 'yan. Hindi mo kailangan maging perfect — kailangan lang magpatuloy.",
    "Salamat sa bagong pagkakataon na walang sugal. Gagawin ko ulit 'to.",
    "Diyos, bigyan Mo ako ng kapayapaan kahit mahirap ang araw na 'to.",
    "Lowkey wins lang. Walang need magmalaki. Basta alam ko, okay ako.",
    "Hindi ko kailangan magmadali. Bawat araw na clean ay sapat na.",
    "Lord, tulungan Mo ako na maging tapat sa pamilya ko ngayon.",
    "One day at a time. Hindi kailangan isipin ang bukas pa.",
    "Bro, proud ako sa'yo kahit maliit lang ang progress mo. Tuloy lang.",
    "Salamat sa mga taong naniniwala sa akin kahit hindi ko pa nasasabi lahat.",
    "Diyos, alisin Mo yung takot ko at palitan ng pag-asa.",
    "Kahit mahirap, mas mahirap kapag bumalik sa sugal. Kaya choose clean.",
    "Wag mag-alala kung mabagal. Basta hindi ka tumitigil.",
    "Lord, bigyan Mo ako ng lakas na harapin ang urge nang hindi ako natatalo.",
    "One moment lang. Hindi kailangan isipin ang buong linggo.",
    "Bro, hindi ka mahina. Nahulog lang, pero tumatayo ka pa rin.",
    "Salamat sa maliit na tagumpay. Walang sugal kahapon, walang sugal ngayon.",
    "Diyos, tulungan Mo ako na maging mas malakas sa pamilya ko kaysa sa sugal.",
    "Hindi ako perfect, pero hindi rin ako sumusuko. Isa-isang araw lang.",
    "Lord, bigyan Mo ako ng kapalit na saya na hindi galing sa sugal.",
    "Kahit maliit lang ang hakbang ko, importante na tumutungo ako.",
    "Bro, wag mong kalimutan kung gaano kahirap yung dati. Kaya mo na 'to.",
    "One day clean ulit. Reset lang, hindi end of the world.",
    "Diyos, tulungan Mo ako na maging matatag ngayong araw.",
    "Lowkey lang ang laban. Walang pressure, basta tuloy lang.",
    "Salamat sa bagong umaga na wala pang sugal. Gagawin ko ulit 'to bukas.",
    "Lord, alisin Mo yung isip ko sa app at ilagay sa pamilya ko.",
    "Hindi kailangan maging number 1 sa clean streak. Enough na yung ngayon.",
    "Bro, proud ako sa sarili ko kahit isa lang ang araw ko.",
    "Wag mahiya humingi ng tulong. Hindi kahinaan 'yon — lakas 'yon.",
    "Salamat sa mga taong naniniwala sa akin kahit hindi ko pa nasasabi lahat.",
    "Diyos, bigyan Mo ako ng kapayapaan kahit mahirap ang araw na 'to.",
    "Lowkey wins. Hindi kailangan ipost. Basta alam ko, panalo na.",
    ...
    "Hindi ako mahina. Nahulog lang ako, pero tumatayo pa rin.",
    "Salamat sa pagkakataong magsimula ulit kahit ilang beses nang nadulas.",
    "Lord, tulungan Mo ako na maging mas mabuting tatay ngayong araw.",
    "One day at a time. Hindi kailangan magmadali. Basta patuloy lang.",
    "Bro, wag mong isipin ang mga panalo mo noon. Isipin mo ang panalo mo ngayon — clean.",
    "Isang hakbang lang. Hindi kailangan maging malaking hakbang agad.",
    "Diyos, alisin Mo yung takot ko at palitan ng pag-asa.",
    "Kahit mahirap, mas mahirap kapag natalo ka ulit. Kaya choose clean today.",
    "Wag mag-alala kung mabagal ang progress. Basta hindi ka tumitigil.",
    "Lord, bigyan Mo ako ng lakas na harapin ang mga trigger ngayon.",
    ...
    <body>
        ...
        <div class="prayer-box">
            <p>"{daily_prayer}"</p>
            <p style="font-size:28px; margin-top:20px;">— One day at a time lang. Kaya mo 'yan.</p>
        </div>
        ...
        <div class="ticker-container">
            <div class="ticker">
                ...
                "2 years clean pero pag may load sa gcash parang may demonyo na nagsasabi 'one spin lang' grabe talaga" &nbsp;&nbsp;&nbsp;&nbsp;
                "Pinagbili ko na laptop ko para sa sabong. Ngayon wala nang pang-school ng anak ko. Tangina talaga." &nbsp;&nbsp;&nbsp;&nbsp;
                "Nag-text ako sa tropa 'game tayo' kahit 4 months clean na. Isang spin lang daw. Ubos 12k sa isang gabi." &nbsp;&nbsp;&nbsp;&nbsp;
                "Asawa ko umiiyak sa kwarto habang ako naglalaro sa sala. Alam ko nakikita niya pero hindi ko matigil." &nbsp;&nbsp;&nbsp;&nbsp;
                "Utang ko sa lending apps umabot 150k. Lahat dahil sa color game. Hindi ko na alam paano ko sasabihin sa nanay ko." &nbsp;&nbsp;&nbsp;&nbsp;
                "Pag may pera, diretso sa app. Pag wala, nanunungkulan. Cycle na 'to 2 years na. Help." &nbsp;&nbsp;&nbsp;&nbsp;
                "Nagseself-harm ako kapag nalulugi. Isang beses nauntog ko ulo ko sa pader. Ayoko na talaga." &nbsp;&nbsp;&nbsp;&nbsp;
                "Sumali ako sa GA PH last week. Akala ko ako lang, pero marami pala. Salamat sa mga nag-share." &nbsp;&nbsp;&nbsp;&nbsp;
                "From 500 pesos naging 5k per bet. Nanalo 100k isang linggo, kinabukasan zero na naman. Paulit-ulit." &nbsp;&nbsp;&nbsp;&nbsp;
                "Di ko na maabot ang mga anak ko kasi lagi akong stressed sa utang. Sana makalabas pa ako sa ganito." &nbsp;&nbsp;&nbsp;&nbsp;
                "3 days clean pa lang pero grabe yung tremor sa kamay pag wala akong load. Feeling ko mamamatay ako." &nbsp;&nbsp;&nbsp;&nbsp;
                "Every payday diretso sa sabong. Mga anak ko baon wala na. Ngayon 3 months clean pero takot pa rin." &nbsp;&nbsp;&nbsp;&nbsp;
                "Relapse ako last week after 8 months. Isang text lang ng tropa 'game tayo' tapos ubos 15k." &nbsp;&nbsp;&nbsp;&nbsp;
                "Nagtatago ako sa CR para maglaro kasi nahihiya sa pamilya. Feeling ko demonyo na 'ko." &nbsp;&nbsp;&nbsp;&nbsp;
                "Utang ko sa 5-6 umabot 80k dahil sa color game. Pinagbili ko na cellphone ko para mabayaran." &nbsp;&nbsp;&nbsp;&nbsp;
                "One day clean pa lang pero grabe yung panghihinayang sa pera na nasayang. Kaya ko pa ba 'to?" &nbsp;&nbsp;&nbsp;&nbsp;
                "Sumali ako sa GA PH last month. Akala ko ako lang, pero marami pala kaming ganito." &nbsp;&nbsp;&nbsp;&nbsp;
                "Nung nanalo ako 50k sa bingo plus, feeling ko jackpot na. Kinabukasan ubos na + utang pa." &nbsp;&nbsp;&nbsp;&nbsp;
                "Asawa ko nalaman na 200k utang ko sa casino. Sabi niya 'bakit di mo sinabi?' Nahihiya ako sobra." &nbsp;&nbsp;&nbsp;&nbsp;
                "From 1k bet naging 10k per game hanggang sa pawn ng motor. Tanga talaga ako nun." &nbsp;&nbsp;&nbsp;&nbsp;
                "Pag may pera, diretso sa app. Pag wala, nanunungkulan. Cycle na 'to 2 years na." &nbsp;&nbsp;&nbsp;&nbsp;
                "Nagseself-harm ako kapag nalulugi. Isang beses nauntog ko ulo ko sa pader." &nbsp;&nbsp;&nbsp;&nbsp;
                "3 months clean pero takot pa rin ako pag may load sa gcash." &nbsp;&nbsp;&nbsp;&nbsp;
                "Relapse ako after 8 months. Isang text lang ng tropa 'game tayo' tapos ubos 15k." &nbsp;&nbsp;&nbsp;&nbsp;
                "Nagtatago ako sa CR para maglaro. Feeling ko demonyo na 'ko." &nbsp;&nbsp;&nbsp;&nbsp;
                "Utang ko umabot 80k dahil sa color game. Pinagbili ko cellphone ko." &nbsp;&nbsp;&nbsp;&nbsp;
                "One day clean pa lang pero grabe yung panghihinayang sa pera." &nbsp;&nbsp;&nbsp;&nbsp;
                "Sumali ako sa GA PH. Marami pala kaming ganito." &nbsp;&nbsp;&nbsp;&nbsp;
                "Nanalo 50k sa bingo plus, kinabukasan zero na naman." &nbsp;&nbsp;&nbsp;&nbsp;
                "Asawa ko umiiyak habang ako naglalaro. Hindi ko matigil." &nbsp;&nbsp;&nbsp;&nbsp;
                "From 500 pesos naging 5k per bet. Paulit-ulit." &nbsp;&nbsp;&nbsp;&nbsp;
                "Di ko na maabot ang mga anak ko dahil sa utang." &nbsp;&nbsp;&nbsp;&nbsp;
                "3 days clean pero tremor sa kamay pag walang load." &nbsp;&nbsp;&nbsp;&nbsp;
                "Pinagbili ko laptop para sa sabong. Wala nang pang-school." &nbsp;&nbsp;&nbsp;&nbsp;
                "Nag-text sa tropa 'game tayo' tapos ubos 12k." &nbsp;&nbsp;&nbsp;&nbsp;
                "Asawa ko umiiyak sa kwarto habang ako naglalaro." &nbsp;&nbsp;&nbsp;&nbsp;
                "Utang 150k sa lending apps dahil sa color game." &nbsp;&nbsp;&nbsp;&nbsp;
                "Pag may pera diretso sa app. Cycle na 'to 2 years." &nbsp;&nbsp;&nbsp;&nbsp;
                "Nagseself-harm kapag nalulugi. Untog ulo sa pader." &nbsp;&nbsp;&nbsp;&nbsp;
                "Sumali sa GA PH. Marami pala kaming ganito." &nbsp;&nbsp;&nbsp;&nbsp;
                "From 1k bet naging 10k. Pawn ng motor." &nbsp;&nbsp;&nbsp;&nbsp;
                "Every payday diretso sa sabong. Baon ng anak wala na." &nbsp;&nbsp;&nbsp;&nbsp;
                "Relapse after 8 months. Isang text lang." &nbsp;&nbsp;&nbsp;&nbsp;
                "Nagtatago sa CR para maglaro. Demoniyo na 'ko." &nbsp;&nbsp;&nbsp;&nbsp;
                "Utang 80k sa 5-6 dahil sa color game." &nbsp;&nbsp;&nbsp;&nbsp;
                "One day clean pero panghihinayang sa pera." &nbsp;&nbsp;&nbsp;&nbsp;
                "Sumali sa GA PH last month. Salamat sa mga nag-share." &nbsp;&nbsp;&nbsp;&nbsp;
                "Nanalo 50k sa bingo plus, kinabukasan zero." &nbsp;&nbsp;&nbsp;&nbsp;
                "Asawa ko nalaman 200k utang. Nahihiya ako." &nbsp;&nbsp;&nbsp;&nbsp;
                "From 500 pesos naging 5k bet. Paulit-ulit." &nbsp;&nbsp;&nbsp;&nbsp;
                "Di ko na maabot ang mga anak ko dahil sa stress." &nbsp;&nbsp;&nbsp;&nbsp;
                "3 days clean pero tremor sa kamay." &nbsp;&nbsp;&nbsp;&nbsp;
                "Pinagbili laptop para sa sabong." &nbsp;&nbsp;&nbsp;&nbsp;
                "Nag-text tropa 'game tayo' tapos ubos 12k." &nbsp;&nbsp;&nbsp;&nbsp;
                "Asawa ko umiiyak habang naglalaro ako." &nbsp;&nbsp;&nbsp;&nbsp;
                "Utang 150k sa lending dahil sa color game." &nbsp;&nbsp;&nbsp;&nbsp;
                "Pag may pera diretso sa app." &nbsp;&nbsp;&nbsp;&nbsp;
                "Nagseself-harm kapag nalulugi." &nbsp;&nbsp;&nbsp;&nbsp;
                "Sumali sa GA PH. Marami pala kaming ganito." &nbsp;&nbsp;&nbsp;&nbsp;
                "From 1k bet naging 10k. Pawn ng motor." &nbsp;&nbsp;&nbsp;&nbsp;
                "Every payday diretso sa sabong." &nbsp;&nbsp;&nbsp;&nbsp;
                "Relapse after 8 months." &nbsp;&nbsp;&nbsp;&nbsp;
                "Nagtatago sa CR para maglaro." &nbsp;&nbsp;&nbsp;&nbsp;
                "Utang 80k sa 5-6." &nbsp;&nbsp;&nbsp;&nbsp;
                "One day clean pero panghihinayang." &nbsp;&nbsp;&nbsp;&nbsp;
                "Sumali sa GA PH last month." &nbsp;&nbsp;&nbsp;&nbsp;
                "Nanalo 50k sa bingo plus." &nbsp;&nbsp;&nbsp;&nbsp;
                "Asawa ko nalaman 200k utang." &nbsp;&nbsp;&nbsp;&nbsp;
                "From 500 pesos naging 5k bet." &nbsp;&nbsp;&nbsp;&nbsp;
                "Di ko na maabot ang mga anak ko." &nbsp;&nbsp;&nbsp;&nbsp;
                "3 days clean pero tremor." &nbsp;&nbsp;&nbsp;&nbsp;
                "Pinagbili laptop para sa sabong." &nbsp;&nbsp;&nbsp;&nbsp;
                "Nag-text tropa 'game tayo'." &nbsp;&nbsp;&nbsp;&nbsp;
                "Asawa ko umiiyak." &nbsp;&nbsp;&nbsp;&nbsp;
                "Utang 150k sa lending." &nbsp;&nbsp;&nbsp;&nbsp;
                "Pag may pera diretso sa app." &nbsp;&nbsp;&nbsp;&nbsp;
                "Nagseself-harm kapag nalulugi." &nbsp;&nbsp;&nbsp;&nbsp;
                "Sumali sa GA PH." &nbsp;&nbsp;&nbsp;&nbsp;
                "From 1k bet naging 10k." &nbsp;&nbsp;&nbsp;&nbsp;
                "Every payday diretso sa sabong." &nbsp;&nbsp;&nbsp;&nbsp;
                "Relapse after 8 months." &nbsp;&nbsp;&nbsp;&nbsp;
                "Nagtatago sa CR." &nbsp;&nbsp;&nbsp;&nbsp;
                "Utang 80k sa 5-6." &nbsp;&nbsp;&nbsp;&nbsp;
                ...
                "Nanalo 50k sa bingo." &nbsp;&nbsp;&nbsp;&nbsp;
                "Asawa ko nalaman." &nbsp;&nbsp;&nbsp;&nbsp;
                "From 500 pesos naging 5k." &nbsp;&nbsp;&nbsp;&nbsp;
                "Di ko na maabot ang anak ko." &nbsp;&nbsp;&nbsp;&nbsp;
                "3 days clean." &nbsp;&nbsp;&nbsp;&nbsp;
                "Pinagbili laptop." &nbsp;&nbsp;&nbsp;&nbsp;
                "Nag-text tropa." &nbsp;&nbsp;&nbsp;&nbsp;
                "Asawa ko umiiyak." &nbsp;&nbsp;&nbsp;&nbsp;
                "Utang 150k." &nbsp;&nbsp;&nbsp;&nbsp;
                "Pag may pera diretso." &nbsp;&nbsp;&nbsp;&nbsp;
                "Nagseself-harm." &nbsp;&nbsp;&nbsp;&nbsp;
                "Sumali sa GA PH." &nbsp;&nbsp;&nbsp;&nbsp;
            </div>
        </div>
        ...
        <div class="video-box">
            <h2 style="color: #228B22; font-size: 40px; margin-bottom: 20px;">Sugal walang kakahantungan</h2>
            <iframe width="560" height="315" src="https://www.youtube.com/embed/0GelF4Nc95M?si=Fi_NVxgAUwGsyuvm" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
            <p style="font-size: 28px; margin-top: 20px;">(Video mula sa YouTube - RaffyTulfoInAction)</p>
        </div>

        <div class="video-box">
            <h2 style="color: #228B22; font-size: 40px; margin-bottom: 20px;">Bakit laging talo ka sa online Sugal</h2>
            <iframe width="560" height="315" src="https://www.youtube.com/embed/V_QerovEnW4?si=Fi_NVxgAUwGsyuvm" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
            <p style="font-size: 28px; margin-top: 20px;">(Video mula sa YouTube - @mooblytv)</p>
        </div>
